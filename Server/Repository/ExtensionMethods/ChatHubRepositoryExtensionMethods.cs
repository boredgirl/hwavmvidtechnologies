...
namespace Oqtane.ChatHubs.Repository
{
    public static class ChatHubRepositoryExtensionMethods
    {
        ...
        public static ChatHubConnection ById(this IQueryable<ChatHubConnection> connections, int id)
        {
        ...
        public static IQueryable<ChatHubRoom> FilterByModuleId(this IQueryable<ChatHubRoom> rooms, int moduleId)
        {
